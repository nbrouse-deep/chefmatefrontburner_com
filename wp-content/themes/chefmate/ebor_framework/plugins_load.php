...
function my_theme_register_required_plugins() {
	 ...
	 */
	$config = array(
		'domain'       		=> 'kyte',         	// Text domain - likely want to be the same as your theme.
		...
		'strings'      		=> array(
			'page_title'                       			=> __( 'Install Required Plugins', 'kyte' ),
			'menu_title'                       			=> __( 'Install Plugins', 'kyte' ),
			'installing'                       			=> __( 'Installing Plugin: %s', 'kyte' ), // %1$s = plugin name
			'oops'                             			=> __( 'Something went wrong with the plugin API.', 'kyte' ),
			...
			'return'                           			=> __( 'Return to Required Plugins Installer', 'kyte' ),
			'plugin_activated'                 			=> __( 'Plugin activated successfully.', 'kyte' ),
			'complete' 									=> __( 'All plugins installed and activated successfully. %s', 'kyte' ), // %1$s = dashboard link
